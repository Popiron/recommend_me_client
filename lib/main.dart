...
import 'package:recommend_me/views/pages/content_page.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<RelatedGamesBloc>(create: (context) => RelatedGamesBloc()),
        BlocProvider<RelatedFilmsBloc>(create: (context) => RelatedFilmsBloc()),
      ],
      child: MaterialApp(
        title: 'RecommendMe',
        theme: ThemeData(
